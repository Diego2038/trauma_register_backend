...
class PatientDataSerializer(serializers.ModelSerializer):
  healthcare_record = HealthcareRecordSerializer(required=False, allow_null=True,)
  injury_record = InjuryRecordSerializer(required=False, allow_null=True,)
  collision = CollisionSerializer(required=False, allow_null=True, many=True,)
  drug_abuse = DrugAbuseSerializer(required=False, allow_null=True, many=True,)
  vital_sign_gcs_qualifier = VitalSignGcsQualifierSerializer(required=False, allow_null=True, many=True,)
  hospitalization_variable = HospitalizationVariableSerializer(required=False, allow_null=True, many=True,)
  hospitalization_complication = HospitalizationComplicationSerializer(required=False, allow_null=True, many=True,)
  trauma_register_icd10 = TraumaRegisterIcd10Serializer(required=False, allow_null=True, many=True,)
  intensive_care_unit = IntensiveCareUnitSerializer(required=False, allow_null=True, many=True,)
  imaging = ImagingSerializer(required=False, allow_null=True, many=True,)
  apparent_intent_injury = ApparentIntentInjurySerializer(required=False, allow_null=True, many=True,)
  burn_injury = BurnInjurySerializer(required=False, allow_null=True, many=True,)
  firearm_injury = FirearmInjurySerializer(required=False, allow_null=True, many=True,)
  penetrating_injury = PenetratingInjurySerializer(required=False, allow_null=True, many=True,)
  poisoning_injury = PoisoningInjurySerializer(required=False, allow_null=True, many=True,)
  violence_injury = ViolenceInjurySerializer(required=False, allow_null=True, many=True,)
  device = DeviceSerializer(required=False, allow_null=True, many=True,)
  laboratory = LaboratorySerializer(required=False, allow_null=True, many=True,)
  physical_exam_body_part_injury = PhysicalExamBodyPartInjurySerializer(required=False, allow_null=True, many=True,)
  procedure = ProcedureSerializer(required=False, allow_null=True, many=True,)
  prehospital_procedure = PrehospitalProcedureSerializer(required=False, allow_null=True, many=True,)
  transportation_mode = TransportationModeSerializer(required=False, allow_null=True, many=True,)
  vital_sign = VitalSignSerializer(required=False, allow_null=True, many=True,)
