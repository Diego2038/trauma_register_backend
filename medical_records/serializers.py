...
class PatientDataSerializer(serializers.ModelSerializer):
  healthcare_record = HealthcareRecordSerializer(required=False, allow_null=True, read_only=True)
  injury_record = InjuryRecordSerializer(required=False, allow_null=True, read_only=True)
  collision = CollisionSerializer(required=False, allow_null=True, many=True, read_only=True)
  drug_abuse = DrugAbuseSerializer(required=False, allow_null=True, many=True, read_only=True)
  vital_sign_gcs_qualifier = VitalSignGcsQualifierSerializer(required=False, allow_null=True, many=True, read_only=True)
  hospitalization_variable = HospitalizationVariableSerializer(required=False, allow_null=True, many=True, read_only=True)
  hospitalization_complication = HospitalizationComplicationSerializer(required=False, allow_null=True, many=True, read_only=True)
  trauma_register_icd10 = TraumaRegisterIcd10Serializer(required=False, allow_null=True, many=True, read_only=True)
  intensive_care_unit = IntensiveCareUnitSerializer(required=False, allow_null=True, many=True, read_only=True)
  imaging = ImagingSerializer(required=False, allow_null=True, many=True, read_only=True)
  apparent_intent_injury = ApparentIntentInjurySerializer(required=False, allow_null=True, many=True, read_only=True)
  burn_injury = BurnInjurySerializer(required=False, allow_null=True, many=True, read_only=True)
  firearm_injury = FirearmInjurySerializer(required=False, allow_null=True, many=True, read_only=True)
  penetrating_injury = PenetratingInjurySerializer(required=False, allow_null=True, many=True, read_only=True)
  poisoning_injury = PoisoningInjurySerializer(required=False, allow_null=True, many=True, read_only=True)
  violence_injury = ViolenceInjurySerializer(required=False, allow_null=True, many=True, read_only=True)
  device = DeviceSerializer(required=False, allow_null=True, many=True, read_only=True)
  laboratory = LaboratorySerializer(required=False, allow_null=True, many=True, read_only=True)
  physical_exam_body_part_injury = PhysicalExamBodyPartInjurySerializer(required=False, allow_null=True, many=True, read_only=True)
  procedure = ProcedureSerializer(required=False, allow_null=True, many=True, read_only=True)
  prehospital_procedure = PrehospitalProcedureSerializer(required=False, allow_null=True, many=True, read_only=True)
  transportation_mode = TransportationModeSerializer(required=False, allow_null=True, many=True, read_only=True)
  vital_sign = VitalSignSerializer(required=False, allow_null=True, many=True, read_only=True)
