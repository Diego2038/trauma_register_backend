...
class HealthcareRecord(models.Model):
    ...
    tiempo_en_sala_de_emergencias_hora = models.SmallIntegerField(null=True, blank=True, default=None)
    ...
    tiempo_de_extricacion_hora = models.SmallIntegerField(null=True, blank=True, default=None)
    ...
    sangre_l = models.DecimalField(max_digits=14, decimal_places=10, null=True, blank=True, default=None)
    coloides_l = models.DecimalField(max_digits=14, decimal_places=10, null=True, blank=True, default=None)
    cristaloides_l = models.DecimalField(max_digits=14, decimal_places=10, null=True, blank=True, default=None)
