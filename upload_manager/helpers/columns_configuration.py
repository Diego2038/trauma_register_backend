...
columns_ubication : dict[str, dict[str,str]] = {  
    ...
    "Trauma Register:2": { #!* Health Patient Attention
      ...
      "tiempo_en_sala_de_emergencias_horas": "BI",
      ...
      "tiempo_de_extricacion_horas": "CE",
...
column_name_type_to_model : dict[str,dict[str,Model|dict[str,DataTypeCell]]] = {  
    ...
    "Trauma Register:2": {
      ...
      "type": {
        ...
        "tiempo_en_sala_de_emergencias_horas": DataTypeCell.INT,
        ...
        "tiempo_de_extricacion_horas": DataTypeCell.INT,
